...
object Module {
    ...
    @Provides
    @Singleton
    fun getRetrofitClient(oAuthInterceptor: OAuthInterceptor): OkHttpClient = OkHttpClient.Builder()
        .addInterceptor(oAuthInterceptor).addInterceptor(HttpLoggingInterceptor().apply {
        setLevel(HttpLoggingInterceptor.Level.BODY)
    }).build()

    @Provides
    @Singleton
    fun getInterceptor(): OAuthInterceptor = OAuthInterceptor()
